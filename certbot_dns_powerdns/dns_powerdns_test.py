...
class AuthenticatorTest(test_util.TempDirTestCase, dns_test_common_lexicon.BaseLexiconAuthenticatorTest):
	...
	def setUp(self) -> None:
		...
		self.config = mock.MagicMock(powerdns_credentials=path, powerdns_propagation_seconds=0)  # don't wait during tests
...
class PowerDnsLexiconClientTest(unittest.TestCase, dns_test_common_lexicon.BaseLexiconClientTest):
